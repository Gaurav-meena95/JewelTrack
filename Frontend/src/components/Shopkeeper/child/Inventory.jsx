...
const Inventory = () => {
   ...
   return (
      ...
      <div className={`space-y-6 min-h-screen ${showModal ? 'blur-[2px] pointer-events-none' : ''}`}>
         ...
         {/* ─── Search & Filters ──────────────────────────────────────────────── */}
         <div className='flex flex-col md:flex-row justify-between gap-4 bg-secondary/30 p-4 rounded-xl border border-border/50'>
         ...
         {/* ─── Inventory Table ───────────────────────────────────────────────── */}
         <div className='bg-card/40 rounded-xl border border-border/50 overflow-hidden overflow-x-auto'>
