        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            ...
            >
              ...
              <div className='flex-1 min-w-0'>
                ...
                <div className='mt-3 flex flex-wrap gap-2 text-xs'>
                  <span className='bg-secondary px-2 py-1 rounded'>{customer.totalAccounts} Girvi Accounts</span>
                ...
                <p className='text-xs text-muted-foreground mt-2'>Last activity: {formatDate(customer.lastUpdated)}</p>
              </div>
            </div>
          ))}
          {uniqueCustomers.length === 0 && (
            <div className='col-span-full text-center py-20 text-muted-foreground'>
              ...
              <p>No collateral accounts found. Create a new one to get started.</p>
            </div>
          )}
        </div>
      )}
...
export default CollateralDashboardView;
